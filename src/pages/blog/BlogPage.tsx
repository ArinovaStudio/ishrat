...
import { BLCards } from '../../elements/Blogs';
...
const BlogPage: React.FC = () => {
      const {data, loading, error} = useSanityQuery<BlogType>({type: 'blogs'});
    ...
    <div className="min-h-screen h-auto bg-gray-50 py-12 sm:px-20 px-4">
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-600 text-lg font-poppins">
          Discover articles and insights from our latest blog posts
        </p>
      </div>

      {/* Products Grid */}
        <div className="lg:px-10 w-full grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 lg:pr-24 lg:gap-40 gap-10 py-14">
